...
public class Tilgung implements Bestandsvorgang {
	...
	public String toString() {
		return "Tilgung [datum=" + datum + ", depot=" + depot + ", konto=" + konto + ", asset=" + asset + ", valuta="
				+ valuta + ", menge=" + menge + ", betrag=" + betrag + ", kest=" + kest + ", soli=" + soli + "]";
	}
